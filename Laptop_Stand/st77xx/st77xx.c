...
#include "spi.h"
  ...
  #define ST77xx_RESET_HIGH()           HAL_GPIO_WritePin(ST77xx_RESET_Port, ST77xx_RESET_Pin, GPIO_PIN_SET) 
  #define ST77xx_RESET_LOW()            HAL_GPIO_WritePin(ST77xx_RESET_Port, ST77xx_RESET_Pin, GPIO_PIN_RESET)
#endif
...
#else
  #define ST77xx_BLK_HIGH()             HAL_GPIO_WritePin(ST77xx_BLK_Port, ST77xx_BLK_Pin, GPIO_PIN_SET) 
  #define ST77xx_BLK_LOW()              HAL_GPIO_WritePin(ST77xx_BLK_Port, ST77xx_BLK_Pin, GPIO_PIN_RESET)
#endif
